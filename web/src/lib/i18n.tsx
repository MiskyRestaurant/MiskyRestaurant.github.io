...
const es = {
  ...
  reservation: {
    ...
    title: "Vive la experiencia Misky",
    intro:
      "Reserva con anticipación y asegura tu lugar. Para grupos grandes o eventos especiales, escríbenos y armamos algo a tu medida.",
    bullet1: "Confirmación por teléfono o correo",
    bullet2: "Atención de martes a domingo",
    bullet3: "Eventos y celebraciones",
    name: "Nombre completo",
    namePh: "Tu nombre",
    email: "Correo",
    emailPh: "tu@correo.com",
    phone: "Teléfono",
    phonePh: "+1 269 316 0383",
    date: "Fecha",
    time: "Hora",
    guests: "Personas",
    notes: "Notas (opcional)",
    notesPh: "Alergias, celebración, preferencias...",
    submit: "Solicitar reserva",
    sending: "Enviando...",
    success:
      "¡Gracias! Tu solicitud de reserva fue recibida. Te contactaremos para confirmarla.",
    error: "Ocurrió un error. Inténtalo de nuevo.",
    errorSend: "No se pudo enviar la reserva.",
  },
  location: {
    eyebrow: "Visítanos",
...
const en: Messages = {
  ...
  reservation: {
    ...
    title: "Experience Misky",
    intro:
      "Book ahead and secure your spot. For large groups or special events, write to us and we'll put together something just for you.",
    bullet1: "Confirmation by phone or email",
    bullet2: "Open Tuesday to Sunday",
    bullet3: "Events and celebrations",
    name: "Full name",
    namePh: "Your name",
    email: "Email",
    ...
    notesPh: "Allergies, celebration, preferences...",
    submit: "Request reservation",
    sending: "Sending...",
    success:
      "Thank you! Your reservation request was received. We'll contact you to confirm it.",
    error: "Something went wrong. Please try again.",
    errorSend: "The reservation could not be sent.",
  },
  location: {
    eyebrow: "Visit us",
